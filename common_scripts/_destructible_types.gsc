...
makeType( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "toy_security_camera_down":
            toy_security_camera2( var_0, "security_camera_idle_down" );
            break;
        case "toy_security_camera_l_down":
            toy_security_camera2( var_0, "security_camera_idle_l_down" );
            break;
        case "toy_security_camera_still":
            toy_security_camera2( var_0, "security_camera_null" );
            break;
        case "toy_security_camera_still_l_down":
            toy_security_camera2( var_0, "security_camera_null_l_down" );
            break;
        case "toy_security_camera_still_r_down":
            toy_security_camera2( var_0, "security_camera_null_r_down" );
            break;
        ...
        case "toy_terracotta_pot_a_white_dest":
            toy_terracotta_pot( var_0, "a_white" );
            break;
        case "toy_terracotta_pot_a_violet_dest":
            toy_terracotta_pot( var_0, "a_violet" );
            break;
        case "toy_terracotta_pot_b_yellow_dest":
            toy_terracotta_pot( var_0, "b_yellow" );
            break;
        case "toy_terracotta_pot_b_red_dest":
            toy_terracotta_pot( var_0, "b_red" );
            break;
        case "toy_furniture_coffee_table_modern_01":
            toy_furniture_coffee_table_modern( var_0, "1", 55 );
            break;
        case "toy_furniture_coffee_table_modern_02":
            toy_furniture_coffee_table_modern( var_0, "2", 60 );
            break;
        default:
            break;
    }
...
prop_ac_prs_enm_barge_a( var_0 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_enm_barge_a_" + var_0, "tag_origin", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "tag_origin", "ac_prs_enm_barge_a_" + var_0 + "_dam_animated", 250, undefined, 32, "no_melee" );
...
prop_ac_prs_enm_storage_bld( var_0, var_1 )
{
    var_2 = "";
    ...
    common_scripts\_destructible::destructible_create( "prop_ac_prs_enm_storage_bld_" + var_0 + var_2, "p_ac_prs_enm_storage_bld_" + var_0 + var_2, 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "p_ac_prs_enm_storage_bld_" + var_0 + var_2 + "_dam", "ac_prs_enm_storage_bld_" + var_0 + var_2 + "_dam", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( undefined, "explosions/building_explosion_paris_ac130", 0 );
    var_3 = "a";
    ...
    common_scripts\_destructible::destructible_fx( undefined, "explosions/ac_prs_fx_flir_debris_explosion_" + var_3, 0 );
}

prop_ac_prs_enm_tent( var_0 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_enm_tent_" + var_0, "ac_prs_enm_tent_" + var_0 + "_lod0", 250, undefined, 32, "no_melee" );
    var_1 = "ac_prs_enm_tent_" + var_0 + "_lod1";
    ...
    common_scripts\_destructible::destructible_state( var_1, "ac_prs_enm_tent_" + var_0 + "_dam1", 250, undefined, 32, "no_melee" );
...
prop_ac_prs_enm_cargo_crate_a( var_0 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_enm_cargo_crate_a_" + var_0, "ac_prs_enm_cargo_crate_a_" + var_0 + "_lod0", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "ac_prs_enm_cargo_crate_a_" + var_0 + "_lod0", "ac_prs_enm_cargo_crate_a_" + var_0 + "_dam", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( undefined, "explosions/building_explosion_paris_ac130", 0 );
    common_scripts\_destructible::destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_ac_prs_enm_crates( var_0, var_1 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_enm_crates_" + var_0 + "_" + var_1, "ac_prs_enm_crates_" + var_0 + "_" + var_1 + "_lod0", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "ac_prs_enm_crates_" + var_0 + "_" + var_1 + "_dam_lod0", "ac_prs_enm_crates_" + var_0 + "_" + var_1 + "_dam", 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( undefined, "explosions/ac_prs_fx_enm_crates_" + var_0 + "_explosion_1", 0 );
}
...
prop_ac_prs_fps_hc_extc_balcony( var_0, var_1 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_fps_hc_extc_balcony_" + var_0 + var_1, "ac_prs_fps_hc_extc_balcony_" + var_0 + "_lod0", 80, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "ac_prs_fps_hc_extc_balcony_" + var_0 + "_dam" + var_1 + "_lod0", "ac_prs_fps_hc_extc_balcony_" + var_0 + "_dam" + var_1, 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( undefined, "explosions/ac_prs_fx_dust_explosion_a", 0 );
    var_2 = "explosions/ac_prs_fps_extc_balcony_a_explosion_1";

    switch ( var_0 )
    {
        case "b":
            var_2 = "explosions/ac_prs_fps_extc_balcony_b_explosion_1";
            break;
        case "c":
            var_2 = "explosions/ac_prs_fps_extc_balcony_c_explosion_" + var_1;
            break;
    }

    common_scripts\_destructible::destructible_fx( undefined, var_2, 0 );
}

prop_ac_prs_fps_hc_extc_column( var_0, var_1, var_2 )
{
    common_scripts\_destructible::destructible_create( "prop_ac_prs_fps_hc_extc_column_" + var_0 + "_" + var_1 + var_2, "ac_prs_fps_hc_extc_column_" + var_0 + "_" + var_1 + "_lod0", 80, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_state( "ac_prs_fps_hc_extc_column_" + var_0 + "_" + var_1 + "_dam" + var_2 + "_lod0", "ac_prs_fps_hc_extc_column_" + var_0 + "_" + var_1 + "_dam" + var_2, 250, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( undefined, "explosions/ac_prs_fx_dust_explosion_a", 0 );
...
toy_chicken_dlc_idle()
{
    common_scripts\_destructible::destructible_anim( get_precached_anim( "Chicken_cage_pecking_idle" ), #animtree, "setanimknob", undefined, 0, "Chicken_cage_pecking_idle", 1.6 );
    common_scripts\_destructible::destructible_anim( get_precached_anim( "Chicken_cage_seated_idle" ), #animtree, "setanimknob", undefined, 1, "Chicken_cage_seated_idle", 1.6 );
}
...
vehicle_bw_hummer( var_0 )
{
    ...
    common_scripts\_destructible::destructible_explode( 4000, 5000, 210, 250, 50, 300, undefined, undefined, 0.3, 500 );
    common_scripts\_destructible::destructible_anim( %vehicle_80s_sedan1_destroy, #animtree, "setanimknob", undefined, undefined, "vehicle_80s_sedan1_destroy" );
    common_scripts\_destructible::destructible_state( undefined, "vehicle_bw_hummer_destroyed", undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_part( "left_wheel_01_jnt", undefined, 20, undefined, undefined, "no_melee" );
    common_scripts\_destructible::destructible_anim( %vehicle_80s_sedan1_flattire_lf, #animtree, "setanim" );
    common_scripts\_destructible::destructible_sound( "veh_tire_deflate", "bullet" );
    common_scripts\_destructible::destructible_part( "left_wheel_02_jnt", undefined, 20, undefined, undefined, "no_melee" );
...
vehicle_moving_truck( var_0 )
{
    ...
    else if ( var_0 == "vehicle_moving_truck_tham" )
...
toy_security_camera2( var_0, var_1 )
{
    common_scripts\_destructible::destructible_create( var_0, "tag_camera_tilt", 0, undefined, 32 );
    common_scripts\_destructible::destructible_anim( get_precached_anim( var_1 ), #animtree, "setanimknob", undefined, undefined, var_1 );
...
toy_old_wood_barrels( var_0, var_1, var_2 )
{
    common_scripts\_destructible::destructible_create( "toy_old_wood_" + var_0, "tag_origin", 120, undefined, 32, "splash" );
    common_scripts\_destructible::destructible_fx( "tag_origin", "props/old_wood_" + var_1, 1, undefined );
    common_scripts\_destructible::destructible_sound( "exp_old_wood_barrel" );
    common_scripts\_destructible::destructible_explode( 600, 651, 1, 1, 10, 20 );
    common_scripts\_destructible::destructible_state( undefined, "old_wood_barrel_dmg_" + var_2, undefined, undefined, undefined, undefined, undefined, 0 );
}

toy_terracotta_pot( var_0, var_1 )
{
    common_scripts\_destructible::destructible_create( var_0, "tag_origin", 50, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( "tag_origin", "props/prop_terracotta_pot_" + var_1 + "_dest", 1, undefined );
    common_scripts\_destructible::destructible_explode( 600, 651, 1, 1, 10, 20 );
...
toy_furniture_coffee_table_modern( var_0, var_1, var_2 )
{
    common_scripts\_destructible::destructible_create( var_0, "tag_origin", 50, undefined, 32, "no_melee" );
    common_scripts\_destructible::destructible_fx( "tag_fx", "props/furniture_coffee_table_modern_0" + var_1, 1, undefined );
    common_scripts\_destructible::destructible_explode( 600, 1651, var_2, var_2, 10, 20, undefined, 10 );
    common_scripts\_destructible::destructible_state( undefined, "furniture_coffee_table_modern_0" + var_1 + "_dest", undefined, undefined, undefined, undefined, undefined, 0 );
}
